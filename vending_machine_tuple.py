...
while True:
  ...
  while((coin > 0) & (coin % 1 == 0)):
    print("====================================================================================")
    print('음료목록 1.{}(100원), 2.{}(200원), 3.{}(300원) 9. 동전반환, 11.동전 넣기'.format(tuple_product[0], tuple_product[1], tuple_product[2]))
    print("====================================================================================")
    ...
    if drink == 1:
      ...
      if coin >= 100:
        ...
        print('\n{}가 곧 제공됩니다.'.format(str(tuple_product[0])))
        print('거스름돈은 {} 원 입니다.\n'.format(int(remain)))
        coin = remain
        print('현재금액 {} 원\n'.format(int(remain)))
      else:
      ...
      if coin >= 200:
        ...
        print('\n{}가 곧 제공됩니다.'.format(str(tuple_product[1])))
        print('거스름돈은 {} 원 입니다.\n'.format(int(remain)))
        coin = remain
        print('현재금액 {} 원\n'.format(int(remain)))
      else:
      ...
      if coin >= 300:
        ...
        print('\n{}가 곧 제공됩니다.'.format(str(tuple_product[2])))
        print('거스름돈은 {} 원 입니다.\n'.format(int(remain)))
        coin = remain
        print('현재금액 {} 원\n'.format(int(remain)))
      else:
